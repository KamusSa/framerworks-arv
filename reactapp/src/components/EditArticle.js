...
/*
    ...
    3.- Llenar / Repoblar el formulario con los datos
                    ...
                    {this.state.article.title &&
                        <form className="mid-form" onSubmit={this.saveArticle}>
                            ...
                            <div className="form-group">
                                ...
                                <textarea type="content" defaultValue={article.content} ref={this.contentRef} onChange={this.changeState}></textarea>
                                {this.validator.message('content', this.state.article.content, 'required')}
                            </div>
                            <div className="form-group">
                                <label htmlFor="file0"></label>                                
                                <input type="file" name="file0" defaultValue={article.file0} onChange={this.fileChange} />
